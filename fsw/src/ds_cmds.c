...
void DS_CmdGetFileInfo(const CFE_SB_Buffer_t *BufPtr)
{
    ...
    else
    {
        ...
        */
        CFE_MSG_Init(CFE_MSG_PTR(DS_FileInfoPkt), CFE_SB_ValueToMsgId(DS_DIAG_TLM_MID), sizeof(DS_FileInfoPkt_t));
        ...
        */
        CFE_SB_TimeStampMsg(CFE_MSG_PTR(DS_FileInfoPkt));
        CFE_SB_TransmitMsg(CFE_MSG_PTR(DS_FileInfoPkt), true);
