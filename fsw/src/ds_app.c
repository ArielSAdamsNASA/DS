...
void DS_AppProcessHK(void)
{
    ...
    */
    CFE_MSG_Init(CFE_MSG_PTR(HkPacket), CFE_SB_ValueToMsgId(DS_HK_TLM_MID), sizeof(DS_HkPacket_t));
    ...
    */
    CFE_SB_TimeStampMsg(CFE_MSG_PTR(HkPacket));
    CFE_SB_TransmitMsg(CFE_MSG_PTR(HkPacket), true);
}
